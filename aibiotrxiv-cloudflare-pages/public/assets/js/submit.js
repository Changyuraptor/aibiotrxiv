...
function bindSubmit(){
  ...
  if(!member.emailVerified){
    if(notice){notice.style.display='block';notice.innerHTML='<h2>Email verification required</h2><p>Please open the verification email sent to your inbox and click the verification link before drafting and submitting a manuscript.</p>'; }
    form.style.display='none';
    return;
  }
