...
document.addEventListener('DOMContentLoaded',async()=>{await loadRemoteKv();renderAdminSubmissions();renderSubmissionDetail();renderAccepted();renderLayout();renderPreview();renderPublished();renderUnpublished();renderTrash();bindMembersAdmin();});
