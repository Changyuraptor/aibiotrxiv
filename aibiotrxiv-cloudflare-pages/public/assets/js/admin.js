...
function publishAccepted(id){
  ...
  const record={...s,pdfEditedHtml:sanitizedPdfEditedHtml,status:'published',sourceSubmissionId:s.id,articleId,versionGroupId:articleId,siteId:articleId,publishedAt:today,date:today,version:nextVersion,slug:publicSlug(articleId),pdf:s.pdf||'#',versionNote:s.versionNote||'',versionPublishedAt:today};
