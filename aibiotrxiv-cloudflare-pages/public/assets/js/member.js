...
document.addEventListener('DOMContentLoaded',async()=>{await loadRemoteKv();try{await reconcileAdminQueueFromMemberPapers();}catch(e){console.error('Admin queue reconciliation failed',e);}updateMemberNav();initRegister();initVerify();initLogin();initDashboard();initMemberSubmissions();initMemberVersions();initPayment();});
})();
