...
function productionPdfCss(siteCss = "") {
  return `
    ...
    /* v77: canonical PDF preview and published PDF share this single backend template. */
    @page {
      size: A4;
    ...
    body.published-pdf-export .pdf-running-header {
    ...
    body.published-pdf-export .pdf-first-page-header-mask {
...
<div class="pdf-running-header">AIBioTʀχiv AI BIOTHEORY ARCHIVE</div>
<div class="pdf-first-page-header-mask" aria-hidden="true"></div>
${safeFragment}
</body>
</html>`;
}
