...
function productionPdfCss() {
  return `
    ...
    .site-shell, .wide-shell, .layout-workspace, .single-layout-editor, .layout-editor-pane { display: block !important; width: 100% !important; max-width: none !important; margin: 0 !important; padding: 0 !important; overflow: visible !important; position: static !important; }
    .pdf-word-document { display: block !important; background: white !important; padding: 0 !important; border-radius: 0 !important; box-shadow: none !important; }
    .pdf-word-page { width: auto !important; min-height: auto !important; margin: 0 !important; padding: 0 !important; border: 0 !important; border-radius: 0 !important; box-shadow: none !important; outline: none !important; background: #fff !important; overflow: visible !important; }
    .pdf-word-page .pdf-brand { display: flex !important; align-items: center !important; gap: 14px !important; border-bottom: 4px solid #1f3a5f !important; padding-bottom: 20px !important; margin: 0 0 34px !important; }
    .pdf-word-page .pdf-brand img { width: 58px !important; height: 58px !important; object-fit: contain !important; border-radius: 12px !important; background: #fff !important; }
    .pdf-word-page .brand-title { font-family: Georgia, 'Times New Roman', serif !important; color: #1f3a5f !important; background: none !important; -webkit-text-fill-color: initial !important; font-size: 38px !important; line-height: 1.05 !important; }
    .pdf-word-page .brand-subtitle { color: #5b6475 !important; font-size: 11px !important; letter-spacing: .12em !important; text-transform: uppercase !important; }
    .pdf-word-page .pdf-title { font-family: Georgia, 'Times New Roman', serif !important; font-size: 38px !important; line-height: 1.08 !important; margin: 0 0 18px !important; color: #07152b !important; }
    .pdf-authors { font-size: 17px !important; margin: 0 0 8px !important; color: #1f3a5f !important; }
    .pdf-meta { font-size: 15px !important; color: #5b6475 !important; margin: 0 0 28px !important; }
    .pdf-word-editor { font-family: Georgia, 'Times New Roman', serif !important; font-size: 17px !important; line-height: 1.68 !important; color: #07152b !important; min-height: 0 !important; outline: 0 !important; widows: 2; orphans: 2; }
    .pdf-word-editor h2 { font-family: Inter, Arial, sans-serif !important; font-size: 24px !important; line-height: 1.22 !important; color: #1f3a5f !important; margin: 34px 0 12px !important; letter-spacing: -.02em !important; break-after: avoid !important; }
    ...
    .word-abstract-box { background: rgba(47,111,255,.075) !important; border: 1px solid rgba(47,111,255,.16) !important; border-radius: 16px !important; padding: 18px 20px !important; margin: 0 0 28px !important; break-inside: avoid !important; page-break-inside: avoid !important; }
    .word-abstract-box h2 { margin: 0 0 12px !important; padding: 0 !important; }
    .word-figure { position: relative !important; margin: 28px auto 30px !important; padding: 14px !important; border: 1px solid #d1d5db !important; border-radius: 16px !important; background: #fafafa !important; max-width: 92% !important; break-inside: avoid !important; page-break-inside: avoid !important; }
    .word-figure img { display: block !important; width: 100% !important; max-height: 440px !important; height: auto !important; object-fit: contain !important; border-radius: 12px !important; background: #fff !important; }
    .word-figure figcaption { display: block !important; margin-top: 10px !important; font-size: 14px !important; line-height: 1.45 !important; color: #111827 !important; }
