...
function productionPdfCss(siteCss = "") {
  return `
    ...
    /* v78: canonical PDF preview and published PDF share this single backend template.
       Running header is generated by CSS page margin boxes, not by body-fixed elements. */
    @page {
      size: A4;
