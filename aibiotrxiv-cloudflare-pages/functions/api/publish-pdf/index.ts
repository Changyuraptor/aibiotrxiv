...
function productionPdfCss() {
  return `
    ...
    .topbar, footer, .layout-tool, .no-print, .hero-actions, .figure-move-controls, .blog-editor-toolbar, button,
    .page-title, .panel-label, #blogEditorToolbar, .layout-top-actions { display: none !important; }
    .site-shell, .wide-shell, .layout-workspace, .single-layout-editor, .layout-editor-pane,
    .pdf-word-document, .pdf-word-page {
