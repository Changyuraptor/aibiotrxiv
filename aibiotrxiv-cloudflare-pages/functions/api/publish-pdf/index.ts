...
export async function onRequestPost(context: { request: Request; env: Env }) {
  ...
  try {
    ...
    if (previewOnly) {
      return new Response(pdfBuffer, {
        ...
        headers: {
          ...
          "x-aibiotrxiv-pdf-mode": "cloudflare-browser-rendering-preview-v82-first-page-header-removed"
        }
      });
    }
    ...
    const updatedRecord = {
      ...
      pdfGeneratedAt: now,
      pdfGenerationMode: "cloudflare-browser-run-r2-v82-first-page-header-removed",
      pdfSha256: pdfHash,
      htmlSha256: htmlHash
    };
