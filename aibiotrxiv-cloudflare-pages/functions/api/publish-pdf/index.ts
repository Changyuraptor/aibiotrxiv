...
function productionPdfCss(siteCss = "") {
  return `
    ...
    /* v79: canonical PDF preview and published PDF share this single backend template.
       The running header is a real paged-media header: no body-fixed elements.
       It is suppressed on page 1 and placed at the upper-left of pages 2+. */
    @page {
      size: A4;
      margin: 12mm 16mm 20mm 16mm;
      @top-left {
  ...
  const res = await fetch(endpoint, {
    ...
    body: JSON.stringify({
      ...
      pdfOptions: {
        ...
        margin: { top: "12mm", right: "16mm", bottom: "20mm", left: "16mm" },
        timeout: 30000
      },
