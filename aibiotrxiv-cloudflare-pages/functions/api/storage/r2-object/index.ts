...
export async function onRequestPost(context: { request: Request; env: Env }) {
  ...
  if (env.DB) {
    ...
    await env.DB.prepare(`INSERT INTO r2_object_registry
      (id, r2_key, bucket_name, owner_type, owner_id, object_role, mime_type, size_bytes, immutable, created_at)
      ...
      ON CONFLICT(r2_key) DO UPDATE SET
        ...
        deleted_at = NULL`)
      .bind(crypto.randomUUID(), key, String(body.ownerType || ""), String(body.ownerId || ""), "published_pdf", mimeType, bytes.length)
      .run();
  }
