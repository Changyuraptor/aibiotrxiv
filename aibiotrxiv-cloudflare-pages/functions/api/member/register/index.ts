...
export async function onRequestPost(context: any) {
  ...
  return json({ ok: true, message: 'Registration received. Please verify your email before submitting manuscripts.', emailSent: Boolean(env.RESEND_API_KEY && env.EMAIL_FROM) });
}
