...
Static preview is useful for viewing public pages only. Member registration, login, submissions, comments, admin login, D1, and R2 require Cloudflare Pages Functions, so use a Cloudflare Pages deployment or Wrangler Pages dev for functional testing.
